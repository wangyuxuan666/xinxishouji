        ...
        <div class="middle">
          ...
          <el-form-item label="老人学历">
            <el-select v-model="form.education" placeholder="请选择老人学历">
              ...
              <el-option label="小学毕业" value="2"></el-option>
              <el-option label="初中毕业" value="3"></el-option>
              <el-option label="高中毕业" value="4"></el-option>
              <el-option label="大学毕业" value="5"></el-option>
              <el-option label="研究生及以上" value="6"></el-option>
            </el-select>
          </el-form-item>
